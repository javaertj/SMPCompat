 ...
 * @version 1.0
 */
public abstract class MApplication extends TinkerApplication {
...
//    public static String deviceId = "error";
    ...
    protected MApplication(int tinkerFlags, String delegateClassName, String loaderClassName, boolean tinkerLoadVerifyFlag) {
