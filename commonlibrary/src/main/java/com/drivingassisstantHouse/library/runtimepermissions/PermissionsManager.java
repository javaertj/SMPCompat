 ...
 */
package com.drivingassisstantHouse.library.runtimepermissions;
...
/**
 * 包名：com.drivingassisstantHouse.library.runtimepermissions
...
public class PermissionsManager {
    ...
    private synchronized void initializePermissionsMap() {
        ...
        for (Field field : fields) {
            ...
            try {
                ...
                SLog.e("Could not access field", e);
            }
     ...
     */
    private synchronized boolean hasAllPermissions(@Nullable Context context, @NonNull String[] permissions) {
        if (context == null) {
            return false;
        }
