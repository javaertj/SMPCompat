...
public class WheelDrawable extends Drawable {
    ...
    public WheelDrawable(int width, int height, WheelView.WheelViewStyle style,Context context) {
        mWidth = width;
        mHeight = height;
        mStyle = style;
        mContenxt=context;
    ...
    public Context getmContenxt() {
        return mContenxt;
    }

    public void setmContenxt(Context mContenxt) {
