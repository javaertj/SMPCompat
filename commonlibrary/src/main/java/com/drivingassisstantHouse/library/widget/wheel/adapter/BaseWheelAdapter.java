 ...
 */
package com.drivingassisstantHouse.library.widget.wheel.adapter;
...
import com.drivingassisstantHouse.library.widget.wheel.widget.IWheelView;
...
public abstract class BaseWheelAdapter<T> extends BaseAdapter {
    ...
    @Override
    public final View getView(int position, View convertView, ViewGroup parent) {//在两侧添加了空白的view，每侧添加的个数为(mWheelSize / 2)个
        if (mLoop) {
